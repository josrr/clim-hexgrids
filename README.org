...
using [[https://mcclim.common-lisp.dev/][McCLIM]].
 ...
 - *Important* :: The repository on GitHub will no longer receive
   updates. The new home for this project is
   [[https://codeberg.org/joserr/clim-hexgrids][Codeberg]].
...
To run the program, clone [[https://codeberg.org/joserr/clim-hexgrids.git][this]] repository in your Quicklisp
=local-projects= directory

#+BEGIN_SRC
 $ cd ~/quicklisp/local-projects/
 $ git clone https://codeberg.org/joserr/clim-hexgrids.git
#+END_SRC
